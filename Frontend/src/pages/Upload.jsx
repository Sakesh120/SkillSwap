    ...
    <div className="min-h-screen bg-gray-200 px-4 pb-10 pt-28 sm:px-6">
      <div className="form-shell">
        <div className="mx-auto w-full max-w-4xl rounded-[2rem] bg-gray-100 p-6 shadow-md sm:p-8 lg:p-10">
          <h1 className="mb-6 text-center text-3xl font-serif sm:text-4xl">
            Upload Your Video
          </h1>
          ...
          <div className="grid gap-6 rounded-xl bg-gray-200 p-6 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="space-y-6">
              <div>
                <label className="mb-2 block text-lg">Video Caption</label>
                <input
                  value={caption}
              ...
              <div>
                <label className="mb-2 block text-lg">Select Skill Category</label>
              ...
              <div className="flex justify-center lg:justify-start">
                <button
                  ...
                  disabled={loading}
                  className="rounded-full bg-gray-300 px-8 py-2 text-lg shadow transition hover:bg-gray-400"
                >
            ...
            >
              {!preview ? (
                <>
                  <div className="mb-2 text-4xl">Upload</div>
                  <p className="mb-3 text-sm">Drag & drop or</p>
                  ...
                  <p className="mt-2 text-xs">MP4 or MOV, max 500MB</p>
                </>
              ) : (
                <video
                  src={preview}
